            ...
            <div style={{ flex: 1 }}>
              <div className="p-4  text-heading bg-gray-100/5 backdrop-blur-xl rounded-xl rounded-b-none  ">
                <iframe
                  ...
                  allowFullScreen
                ></iframe>
                <div className="flex flex-col lg:flex-row lg:items-center gap-4 md:gap-6 py-8 border-b border-gray-300/20">
                  <div className="flex items-center gap-6">
                    <p className="text-purple line-through font-semibold text-lg">
                      ২০,০০০/-
                    </p>
                    <p className="text-4xl font-bold mr-8">৮,০০০/-</p>
                  </div>
                ...
                <button className="bg-[#1CAB55] py-3 w-full mt-8 rounded-xl hover:bg-opacity-50 ease-in-out duration-150">
                  কোর্সটি কিনুন
                </button>
              </div>
