        ...
        <div className="py-16 bg-[#0B060D] overflow-x-hidden">
          <div className="w-[90%] lgXl:w-[80%] mx-auto py-12 z-20">
            <div className="min-h-[80vh]">
              <p className="text-heading text-3xl">আপনার নোটিফিকেশানস</p>
              <div className="mt-10">
                <div className="flex items-center  gap-8 hover:bg-gray-400/10 ease-in-out duration-150 cursor-pointer bg-[#0B060D] bg-opacity-30  backdrop-blur-lg border border-gray-200/20 rounded-md my-4 p-8">
                  <svg
                    height={30}
                    width={30}
                    viewBox="0 0 24 24"
                ...
                <div className="flex items-center  gap-8 hover:bg-gray-400/10 ease-in-out duration-150 cursor-pointer bg-[#0B060D] bg-opacity-30  backdrop-blur-lg border border-gray-200/20 rounded-md my-4 p-8">
                  ...
                  <div className="flex w-full justify-center">
                    <p className="text-heading text-xl">Custom Admin Message</p>
                  </div>
                </div>
              </div>
            </div>
