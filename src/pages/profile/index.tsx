      ...
      >
        ...
        <div className="overflow-x-hidden bg-white py-16 dark:bg-[#0E0E0E]">
          <div className="z-20 mx-auto min-h-[80vh] w-[90%] py-12 lgXl:w-[80%]">
            <div className="flex flex-col items-center lg:flex-row  justify-between gap-20 w-full">
              ...
              <div className="rounded-xl flex-[3] border py-16 px-8 border-[#2BA98B]/50 bg-gray-400/20 backdrop-blur-lg dark:bg-gray-200/5 w-full">
