        ...
        <div className="w-full md:w-[80%] mx-auto flex-col ">
          <div>
            ...
            <p className="mt-1 text-paragraph dark:text-darkParagraph">
              Add your address where you want to get your gift
            </p>
          </div>
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-y-4 gap-x-12">
            <div className="">
            ...
            <div className="">
              ...
              >
                ...
                <option className=" dark:bg-black" value="S">
                  S
                </option>
                <option className=" dark:bg-black" value="M">
                  M
                </option>
                <option className=" dark:bg-black" value="L">
                  L
                </option>
                <option className=" dark:bg-black" value="XL">
                  XL
                </option>
                <option className=" dark:bg-black" value="XXL">
                  XXL
                </option>
              </select>
            </div>
            ...
            <div className="">
              ...
              >
                ...
                {subDistricts.upazilas.map((subDistrict, index) => {
                  if (subDistrict.district_id == district) {
                    return (
                      <option
                        className="dark:bg-black"
                        key={index}
            ...
            <div className="">
              <p className="text-paragraph dark:text-darkParagraph mb-1 font-xl">
                Full Address (Add road number & area)
              </p>
              <input className="w-full bg-white/0 border border-gray-500 dark:border-gray-200/20 outline-none text-heading dark:text-darkHeading px-4 py-2 text-xl rounded-lg" />
            </div>
          </div>
